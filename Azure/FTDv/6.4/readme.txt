...
URL  : https://software.cisco.com/download/home/286306503/type/286306337/release/6.4.0 
File : [ Firepower NGFW Virtual v6.4.0 on Azure ]  Cisco_Firepower_Threat_Defense_Virtual-6.4.0-102.vhd.bz2
...
6. virtualNetworkResourceGroup: The name of the virtual network's Resource Group. The Firepower Threat Defense Virtual is always deployed into a new Resource Group.
e.g. ew-west8-rg

7. virtualNetworkName: The name of the virtual network.
e.g. ew-west8-vnet

8. mgmtSubnetName: The management interface will attach to this subnet. This maps to Nic0, the first subnet. Note, this must match an existing subnet name if joining an existing network.
e.g. mgmt

9. mgmtSubnetIP: The Management interface IP address.
e.g. 10.8.0.55

10. diagSubnetName: The diagnostic interface will attach to this subnet. This maps to Nic1, the second subnet. Note, this must match an existing subnet name if joining an existing network.
e.g. diag

11. diagSubnetIP: The diagnostic interface IP address.
e.g. 10.8.1.55

12. gig00SubnetName: The GigabitEthernet 0/0 interface will attach to this subnet. This maps to Nic2, the third subnet. Note, this must match an existing subnet name if joining an existing network.
e.g. inside

13. gig00SubnetIP: The GigabitEthernet 0/0 interface IP address. This is for Firepower Threat Defense Virtual’s first data interface.
e.g. 10.8.2.55

14. gig01SubnetName: The GigabitEthernet 0/1 interface will attach to this subnet. This maps to Nic3, the third subnet. Note, this must match an existing subnet name if joining an existing network.
e.g. outside

15. gig01SubnetIP: The GigabitEthernet 0/1 interface IP address. This is for Firepower Threat Defense Virtual’s second data interface.
e.g. 10.8.3.55

16. vmSize: The VM size to use for the Firepower Threat Defense Virtual VM. Standard_D3_V2 and Standard_D3 are supported. Standard_D3_V2 is the default.
e.g. Standard_D3_V2 or Standard_D3
